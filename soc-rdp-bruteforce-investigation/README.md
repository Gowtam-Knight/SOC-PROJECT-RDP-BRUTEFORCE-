...
![Splunk SIEM](https://img.shields.io/badge/SIEM-Splunk_Enterprise-2ca02c?style=for-the-badge&logo=splunk)
![Windows Server](https://img.shields.io/badge/Target-Windows_Event_Log-0078d7?style=for-the-badge&logo=windows)
![Kali Linux](https://img.shields.io/badge/Attacker-Kali_Linux-557c99?style=for-the-badge&logo=kalilinux)
![MITRE ATT&CK](https://img.shields.io/badge/Framework-MITRE_ATT%26CK-orange?style=for-the-badge)
![Security-Level](https://img.shields.io/badge/Security-Blue_Team_/_SOC_Tier_1--2-critical?style=for-the-badge)
...
1. **Firewall Isolation:** Applied immediate rule blocking inbound traffic from `192.168.10.50`:
   ```cmd
   netsh advfirewall firewall add rule name="BLOCK-ATTACKER-IP" dir=in action=block remoteip=192.168.10.50
   ```
2. **Account Lockout Policy:** Configured threshold to lock accounts after **5 failed attempts for 30 minutes**.
3. **Network Level Authentication (NLA):** Enforced NLA to prevent unauthenticated RDP sessions.

---

## 📜 Incident Report & Documentation

- [Full Incident Response Report](docs/incident_response_report.md)
- [MITRE ATT&CK Matrix Mapping](docs/mitre_attack_mapping.md)
- [Splunk SPL Playbook](detections/splunk_alerts_and_rules.md)
- [Windows Hardening Playbook](docs/remediation_hardening_guide.md)
- [Sigma Detection Rule](detections/sigma_rule_rdp_bruteforce.yml)
